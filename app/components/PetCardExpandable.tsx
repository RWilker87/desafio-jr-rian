                ...
                >
                    ...
                    <div className="flex gap-3">
                        ...
                        <button
                            ...
                            className="flex-1 px-4 py-3 bg-white hover:bg-gray-100 text-[#0056E2] font-semibold rounded-lg transition flex items-center justify-center gap-2"
                        >
                        ...
                        <button
                            ...
                            className="flex-1 px-4 py-3 bg-gradient-to-r from-[#00CAFC] to-[#0056E2] hover:opacity-90 text-white font-semibold rounded-lg transition flex items-center justify-center gap-2"
                        >
                            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
